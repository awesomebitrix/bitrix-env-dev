...
Наш контейнер будем называть **project.local**, айпишник ему выставим **10.10.0.2**
...
После этого можно подключаться к нашему контейнеру через доменное имя _project.local_