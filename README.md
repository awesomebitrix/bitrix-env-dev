...
В итоге у вас получится число контейнеров в системе, равное количеству проектов, плюс 1 с базами к этим проектам.
...
* заходим через админку в `Главный модуль` и `Список сайтов` и меняем урлы и доменные имена на `project.local`; если этого не сделать, то вы можете столкнуться с парой проблем, одна из которых - постоянная разавторизация
