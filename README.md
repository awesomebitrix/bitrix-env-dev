...
Но постепенно я расширил функционал и образ очень даже пригоден и для продакшна.
...
В IDE мы будем править Git-репозиторий проекта. Синхронизировать файлы проекта мы будем через scp/ssh, направленный на запущенный контейнер. 
